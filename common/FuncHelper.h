...
using namespace std;
    ...
    typedef std::atomic<pthread_t>				atomic_tid;
...
#define THREAD_YIELD_CYCLE	511
#define THREAD_SWITCH_CYCLE	8191
...
#define SET_NONBLOCK(x) fcntl(x, F_SETFL, O_NONBLOCK)
#define SET_CLOEXEC(x) fcntl(x, F_SETFL, O_CLOEXEC)
#define SET_NONBLOCK_CLOEXEC(x) fcntl(x, F_SETFL, O_NONBLOCK | O_CLOEXEC)
